...
For the pre-RT task, first the [checkpoint](https://drive.google.com/file/d/1M9sKnvNpJpWuNEAzq2GVf0K1P22zvkcV/view?usp=sharing) needs to be downloaded and moved to [workdir/nnUNet_trained_models/Dataset030/nnUNetTrainer__nnUNetResEncUNetMPlans_24Gb__3d_fullres/fold_all](workdir/nnUNet_trained_models/Dataset030/nnUNetTrainer__nnUNetResEncUNetMPlans_24Gb__3d_fullres/fold_all) before running inference with:
...
Similar, for the mid-RT, the final [checkpoint](https://drive.google.com/file/d/17VO1WCNibZw86u_6Rm2jMLJzaUm9fjXu/view?usp=sharing) needs to be downloaded and moved to [workdir/nnUNet_trained_models/Dataset031/nnUNetTrainer__nnUNetResEncUNetMPlans_24Gb_masked_oversampler__3d_fullres_oversample/fold_all](workdir/nnUNet_trained_models/Dataset031/nnUNetTrainer__nnUNetResEncUNetMPlans_24Gb_masked_oversampler__3d_fullres_oversample/fold_all) before running inference with:
